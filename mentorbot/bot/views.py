...
class CreateView(generics.ListCreateAPIView):
    """When a user searches for  a mentorship field, the field is recorded in the bot db"""
...
class SearchListView(generics.ListAPIView):
    """ this allows users to make queries such as http://example.com/bot/search?name=python"""
